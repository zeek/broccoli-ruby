function(uninstall_manifest manifestPath)
    ...
    foreach (file ${files})
        ...
        if (EXISTS "${fileName}" OR IS_SYMLINK "${fileName}")
            ...
            execute_process(
                COMMAND "/opt/local/bin/cmake" -E remove "${fileName}"
...
file(GLOB install_manifests /Users/seth/bro/broccoli-ruby.git/install_manifest*.txt)
...
if (install_manifests)
    ...
    message(FATAL_ERROR "Cannot find any install manifests in: "
                        "\"/Users/seth/bro/broccoli-ruby.git/install_manifest*.txt\"")
endif ()
